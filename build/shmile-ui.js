...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _appState = __webpack_require__(/*! ./appState */ 6);
	...
	var _photoView = __webpack_require__(/*! ./photoView */ 8);
	
	var _photoView2 = _interopRequireDefault(_photoView);
	
	var _buttonView = __webpack_require__(/*! ./buttonView */ 7);
	
	var _buttonView2 = _interopRequireDefault(_buttonView);
	
	var _reviewButtonView = __webpack_require__(/*! ./reviewButtonView */ 9);
	
	var _reviewButtonView2 = _interopRequireDefault(_reviewButtonView);
	
	var _shmileStateMachine = __webpack_require__(/*! ./shmileStateMachine */ 10);
	
	var _shmileStateMachine2 = _interopRequireDefault(_shmileStateMachine);
	
	var _stateMachineEventHandler = __webpack_require__(/*! ./stateMachineEventHandler */ 13);
	
	var _stateMachineEventHandler2 = _interopRequireDefault(_stateMachineEventHandler);
	
	var _socketProxy = __webpack_require__(/*! ./socketProxy */ 12);
	
	var _socketProxy2 = _interopRequireDefault(_socketProxy);
	
	var _socketLayer = __webpack_require__(/*! ./socketLayer */ 11);
	
	var _socketLayer2 = _interopRequireDefault(_socketLayer);
	
	var _config = __webpack_require__(/*! ./config */ 2);
	
	var _config2 = _interopRequireDefault(_config);
	
	var _cameraUtils = __webpack_require__(/*! ./cameraUtils */ 4);
	
	var _cameraUtils2 = _interopRequireDefault(_cameraUtils);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	__webpack_require__(/*! ../css/shmile.css */ 15);
	
	var Shmile = function Shmile() {};
	Shmile.prototype.initialize = function () {
	  var socketProxy = new _socketProxy2.default();
	  var appState = new _appState2.default();
	
	  // Inter-object communication layer.
	  var channel = {};
	  _underscore2.default.extend(channel, _backbone2.default.Events);
	
	  window.io = window.io || undefined;
	
	  var p = new _photoView2.default(_config2.default, appState, channel);
	  var bv = new _buttonView2.default(channel);
	  var rbv = new _reviewButtonView2.default(channel);
	  var ssm = new _shmileStateMachine2.default(p, socketProxy, appState, _config2.default, bv, rbv, _cameraUtils2.default);
	
	  var eventHandler = new _stateMachineEventHandler2.default(ssm, channel).init();
	
	  bv.fsm = ssm.fsm;
	
	  var layer = new _socketLayer2.default(window.io, socketProxy);
	  layer.init();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Config = {
	  ...
	  window_width: (0, _jquery2.default)(window).width(),
	  window_height: (0, _jquery2.default)(window).height() - 10,
	  overlay_delay: 2000,
	  cheese_delay: 400,
	  flash_duration: 1000,
	  ready_delay: 2000,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	CameraUtils.snap = function (photoView, idx, cheeseCb) {
	  ...
	  photoView.modalMessage('Ready?', _config2.default.ready_delay, 200, function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ButtonView = function ButtonView(channel) {
	...
	ButtonView.prototype.render = function () {
	  var self = this;
	  // init code
	  this.startButton = (0, _jquery2.default)('button#start-button');
	  var buttonX = (_config2.default.window_width - this.startButton.outerWidth()) / 2;
	  var buttonY = (_config2.default.window_height - this.startButton.outerHeight()) / 2;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _raphael = __webpack_require__(/*! ../vendor/raphael */ 14);
	...
	var PhotoView = Backbone.View.extend({
	  ...
	  initialize: function initialize(config, state) {
	    this.config = config;
	    this.canvas = new _raphael2.default('viewport', this.config.window_width, this.config.window_height);
	    (0, _jquery2.default)(this.canvas.canvas).attr('class', 'photo-view');
	    ...
	    this.compositeDim = _cameraUtils2.default.scale4x6(w, h);
	  ...
	  renderFrameAt: function renderFrameAt(idx) {
	    var w = this.frameDim.w;
	    var h = this.frameDim.h;
	    ...
	    var frame = this.canvas.rect(frame_x, frame_y, w, h);
	
	    frame.attr({ 'fill': 'black' });
	    (0, _jquery2.default)(frame.node).attr('class', 'frame-' + idx);
	    var img = this.canvas.image(null, frame_x, frame_y, w, h);
	    (0, _jquery2.default)(img.node).attr('class', 'image-' + idx);
	  ...
	  render: function render() {
	    ...
	    var o = this.canvas.image('/images/overlay.png', this.compositeOrigin.x, this.compositeOrigin.y, this.compositeDim.w, this.compositeDim.h);
	    (0, _jquery2.default)(o.node).attr('class', 'overlay');
	    this.all.push(o);
	    this.overlayImage = o;
	   ...
	   */
	  updatePhotoSet: function updatePhotoSet(img_src, idx, cb) {
	    var view = this;
	    ...
	    var afterShowPhoto = function afterShowPhoto() {
	   ...
	   */
	  animate: function animate(dir, cb) {
	    if (dir === 'in') {
	      this.all.show();
	      this.images.hide();
	   ...
	   */
	  zoomFrame: function zoomFrame(idx, dir, onfinish) {
	    var view = this;
	  ...
	  slideInNext: function slideInNext() {
	    ...
	    this.animate('in', function () {
	      (0, _jquery2.default)('#start-button').fadeIn();
	    });
	  },
	   ...
	   * Faux camera flash
	   */
	  flashEffect: function flashEffect(duration) {
	  ...
	  flashStart: function flashStart(duration) {
	    if (duration === undefined) {
	      duration = 200;
	    }
	  ...
	  flashEnd: function flashEnd(duration) {
	    if (duration === undefined) {
	      duration = 200;
	    }
	    var self = this;
	   ...
	   */
	  modalMessage: function modalMessage(text, persistTime, animateSpeed, cb) {
	    ...
	    var r = this.canvas.rect(x, y, sideLength, sideLength, 15);
	    r.attr({ 'fill': '#222',
	      'fill-opacity': 0.7,
	      'stroke-color': 'white' });
	    all.push(r);
	   ...
	   */
	  showOverlay: function showOverlay(animate) {
	   ...
	   * Removes the overlay
	   */
	  hideOverlay: function hideOverlay(animate) {
	    var view = this;
	    if (animate) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReviewButtonView = function ReviewButtonView(channel) {
	  this.channel = channel;
	};
	...
	ReviewButtonView.prototype.render = function () {
	  var self = this;
	  // init code
	  this.container = (0, _jquery2.default)('#review-buttons');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _javascriptStateMachine = __webpack_require__(/*! javascript-state-machine */ 16);
	 ...
	 */
	var ShmileStateMachine = function ShmileStateMachine(photoView, socket, appState, config, buttonView, reviewButtonView, cameraUtils) {
	  ...
	  this.fsm = _javascriptStateMachine2.default.create({
	    initial: 'loading',
	    events: [{ name: 'connected', from: 'loading', to: 'ready' }, { name: 'ui_button_pressed', from: 'ready', to: 'waiting_for_photo' }, { name: 'photo_saved', from: 'waiting_for_photo', to: 'review_photo' }, { name: 'photo_updated', from: 'review_photo', to: 'next_photo' }, { name: 'continue_partial_set', from: 'next_photo', to: 'waiting_for_photo' }, { name: 'finish_set', from: 'next_photo', to: 'review_composited' }, { name: 'next_set', from: 'review_composited', to: 'ready' }],
	    callbacks: {
	      ...
	      onleaveready: function onleaveready() {},
	      onenterwaiting_for_photo: function onenterwaiting_for_photo(e) {
	        var cheeseCb = function cheeseCb() {
	          self.photoView.modalMessage('Cheese!', self.config.cheese_delay);
	          self.photoView.flashStart();
	          self.socket.emit('snap', true);
	        };
	        self.cameraUtils.snap(self.photoView, self.appState.current_frame_idx, cheeseCb);
	      },
	      onphoto_saved: function onphoto_saved(e, f, t, data) {
	        // update UI
	      ...
	      onphoto_updated: function onphoto_updated(e, f, t) {
	        self.photoView.flashEnd();
	      ...
	      onenterreview_composited: function onenterreview_composited(e, f, t) {
...
/***/ (function(module, exports) {
	 ...
	 */
	var SocketLayer = function SocketLayer(io, proxy) {
	  this.io = io;
	  this.proxy = proxy;
	};
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */
	var SocketProxy = function SocketProxy() {
	  this.socket = null;
	  this.nullChannel = {};
	  _underscore2.default.extend(this.nullChannel, _backbone2.default.Events);
	};
...
/***/ (function(module, exports) {
	 ...
	 */
	var StateMachineEventHandler = function StateMachineEventHandler(stateMachine, channel) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_LOCAL_MODULE_0__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_LOCAL_MODULE_1__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_LOCAL_MODULE_2__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_LOCAL_MODULE_3__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;"use strict";
	...
	(function (glob, factory) {
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__WEBPACK_LOCAL_MODULE_0__], __WEBPACK_LOCAL_MODULE_1__ = (function (eve) {
	            return factory(eve);
	    ...
	    * Retrieves the element data
	    ...
	    \*/
	    R.ninja = function () {
	        oldRaphael.was ? g.win.Raphael = oldRaphael.is : null /*delete Raphael*/;
	        return R;
	    };
	    /*\
	     * Raphael.st
	...
	(function (glob, factory) {
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__WEBPACK_LOCAL_MODULE_1__], __WEBPACK_LOCAL_MODULE_2__ = (function (raphael) {
	...
	(function (glob, factory) {
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__WEBPACK_LOCAL_MODULE_1__], __WEBPACK_LOCAL_MODULE_3__ = (function (raphael) {
	            return factory(raphael);
	        }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)));
	    } else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === "object") {
	        factory(require("./raphael.core"));
	...
	(function (glob, factory) {
	    if (true) {
	        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__WEBPACK_LOCAL_MODULE_1__, __WEBPACK_LOCAL_MODULE_2__, __WEBPACK_LOCAL_MODULE_3__], __WEBPACK_AMD_DEFINE_RESULT__ = function (Raphael) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=shmile-ui.js.map